...
public class TbNetRelConstants {
	...
	static {
		...
		TB_NET_REL_MAP.put(UE, UE_TYPE + StringUtils.DELIMITER_INNER_ITEM + IMS_TAG);
		TB_NET_REL_MAP.put(CELL, EUTRAN_TYPE + StringUtils.DELIMITER_INNER_ITEM + CELLID_TAG);
		TB_NET_REL_MAP.put(SOURCE_CELL, EUTRAN_TYPE + StringUtils.DELIMITER_INNER_ITEM + SOUR_CELLID_TAG);
		TB_NET_REL_MAP.put(TAGGET_CELL, EUTRAN_TYPE + StringUtils.DELIMITER_INNER_ITEM + TAR_CELLID_TAG);
		TB_NET_REL_MAP.put(NEIGHBOR_REL, EUTRAN_TYPE + StringUtils.DELIMITER_INNER_ITEM + SOUR_TAR_CELLID_TAG);
		TB_NET_REL_MAP.put(ENB, EUTRAN_TYPE + StringUtils.DELIMITER_INNER_ITEM + ENBID);
		TB_NET_REL_MAP.put(MME, EPC_TYPE + StringUtils.DELIMITER_INNER_ITEM + MMEGroupID_MME);
		TB_NET_REL_MAP.put(MME_SV, EPC_TYPE + StringUtils.DELIMITER_INNER_ITEM + MME_IP);
		TB_NET_REL_MAP.put(MSC, EPC_TYPE + StringUtils.DELIMITER_INNER_ITEM + MSC_IP);
		TB_NET_REL_MAP.put(IMS, IMS_TYPE + StringUtils.DELIMITER_INNER_ITEM + PCSCF_IP);
	}
