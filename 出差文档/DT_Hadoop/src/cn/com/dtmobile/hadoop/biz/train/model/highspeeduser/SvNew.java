...
//		this.eupordown = ParseUtils.parseInteger(str[53]);
		/*
		this.gridid = StringUtils.isNotEmpty(str[38]) ? Long.valueOf(str[38]) : null;
		this.slong = StringUtils.isNotEmpty(str[39]) ? Double.valueOf(str[39]) : null;
		this.slat = StringUtils.isNotEmpty(str[40]) ? Double.valueOf(str[40]) : null;
		this.dlong = StringUtils.isNotEmpty(str[41]) ? Double.valueOf(str[41]) : null;
		this.dlat = StringUtils.isNotEmpty(str[42]) ? Double.valueOf(str[42]) : null;
		this.distance = StringUtils.isNotEmpty(str[43]) ? Double.valueOf(str[43]) : null;
		this.espeed = StringUtils.isNotEmpty(str[44]) ? Double.valueOf(str[44]) : null;
		this.elong = StringUtils.isNotEmpty(str[45]) ? Double.valueOf(str[45]) : null;
		this.elat = StringUtils.isNotEmpty(str[46]) ? Double.valueOf(str[46]) : null;
		this.falurecause = str[47];
		this.etype = StringUtils.isNotEmpty(str[48]) ? Integer.valueOf(str[48]) : null;
		this.flag = StringUtils.isNotEmpty(str[49]) ? Integer.valueOf(str[49]) : null;
		this.beforeflag = StringUtils.isNotEmpty(str[50]) ? Integer.valueOf(str[50]) : null;
		this.eupordown = StringUtils.isNotEmpty(str[51]) ? Integer.valueOf(str[51]) : null;
		*/
	}
