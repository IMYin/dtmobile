...
public class DataJob extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		DistributedCache.addCacheFile(new URI(otherArgs[9]), conf); // cellid
		...
		MultipleOutputs.addNamedOutput(job, "GX", TextOutputFormat.class,
				NullWritable.class, Text.class);
		MultipleOutputs.addNamedOutput(job, "UU", TextOutputFormat.class,
				NullWritable.class, Text.class);
		MultipleOutputs.addNamedOutput(job, "S1", TextOutputFormat.class,
				NullWritable.class, Text.class);
		MultipleOutputs.addNamedOutput(job, "LTE_MR_SOURCE",
				TextOutputFormat.class, NullWritable.class, Text.class);
		MultipleOutputs.addNamedOutput(job, "SV", TextOutputFormat.class,
				NullWritable.class, Text.class);
		MultipleOutputs.addNamedOutput(job, "SGS", TextOutputFormat.class,
				NullWritable.class, Text.class);
		MultipleOutputs.addNamedOutput(job, "MW", TextOutputFormat.class,
				NullWritable.class, Text.class);
		MultipleOutputs.addNamedOutput(job, "X2", TextOutputFormat.class,
				NullWritable.class, Text.class);
		...
		FileOutputFormat.setOutputPath(job, new Path(otherArgs[8]));
