...
import cn.com.dtmobile.hadoop.biz.exception.mr.VolteNoConnMasterReduce;

@SuppressWarnings("deprecation")
public class VolteNoConnMasterJob extends Configured implements Tool {
	@Override
	public int run(String[] args) throws Exception {
		...
		Job job = new Job(conf, "VolteNoConnMasterJob");
		job.setJarByClass(VolteNoConnMasterJob.class);
		job.setMapperClass(CommonMaps.class);
		job.setReducerClass(VolteNoConnMasterReduce.class);
	...
	public static void main(String[] args) throws Exception {
		try {
			int returnCode = ToolRunner.run(new VolteNoConnMasterJob(), args);
