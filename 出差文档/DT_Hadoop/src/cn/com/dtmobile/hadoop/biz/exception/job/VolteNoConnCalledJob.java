...
import cn.com.dtmobile.hadoop.biz.exception.mr.VolteNoConnCalledReduce;

@SuppressWarnings("deprecation")
public class VolteNoConnCalledJob extends Configured implements Tool {
	@Override
	public int run(String[] args) throws Exception {
		...
		Job job = new Job(conf, "VolteNoConnCalledJob");
		job.setJarByClass(VolteNoConnCalledJob.class);
		job.setMapperClass(CommonMaps.class);
		job.setReducerClass(VolteNoConnCalledReduce.class);
	...
	public static void main(String[] args) throws Exception {
		try {
			int returnCode = ToolRunner.run(new VolteNoConnCalledJob(), args);
