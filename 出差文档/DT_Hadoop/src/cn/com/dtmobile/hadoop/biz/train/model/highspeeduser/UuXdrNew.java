...
public class UuXdrNew {
	...
	public UuXdrNew(String [] str) {
		...
		this.etype = ParseUtils.parseInteger(str[26]);
		...
		/*
		this.gridid = StringUtils.isNotEmpty(str[57]) ? Long.valueOf(str[57]) : null;
		this.slong = StringUtils.isNotEmpty(str[58]) ? Double.valueOf(str[58]) : null;
		this.slat = StringUtils.isNotEmpty(str[59]) ? Double.valueOf(str[59]) : null;
		this.dlong = StringUtils.isNotEmpty(str[60]) ? Double.valueOf(str[60]) : null;
		this.dlat = StringUtils.isNotEmpty(str[61]) ? Double.valueOf(str[61]) : null;
		this.distance = StringUtils.isNotEmpty(str[62]) ? Double.valueOf(str[62]) : null;
		this.espeed = StringUtils.isNotEmpty(str[63]) ? Double.valueOf(str[63]) : null;
		this.elong = StringUtils.isNotEmpty(str[64]) ? Double.valueOf(str[64]) : null;
		this.elat = StringUtils.isNotEmpty(str[65]) ? Double.valueOf(str[65]) : null;
		this.falurecause = str[66];
		this.etype = StringUtils.isNotEmpty(str[67]) ? Integer.valueOf(str[67]) : null;
		this.flag = StringUtils.isNotEmpty(str[68]) ? Integer.valueOf(str[68]) : null;
		this.beforeflag = StringUtils.isNotEmpty(str[69]) ? Integer.valueOf(str[69]) : null;
		this.eupordown = StringUtils.isNotEmpty(str[70]) ? Integer.valueOf(str[70]) : null;
		*/
	}
